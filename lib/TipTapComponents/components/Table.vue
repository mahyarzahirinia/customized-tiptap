...
<style lang="scss">
.tableWrapper {
  @apply overflow-x-auto my-6 first:mt-0;
}
...
.tableWrapper tbody tr td[contenteditable="false"] {
  @apply cursor-text;
}

.tableWrapper tbody tr td[contenteditable="true"] {
  @apply outline-none;
}

.tableWrapper tbody tr td,
.tableWrapper tbody tr th {
  @apply border border-gray-500 box-border min-w-[1em] p-4 relative align-top;
}
...
.tableWrapper tbody tr .selectedCell:after {
  @apply bg-red-200 absolute inset-0 pointer-events-none z-10;
  content: "";
}

.tableWrapper tbody tr .column-resize-handle {
  @apply bg-blue-500 absolute right-[-2px] top-0 bottom-[-2px] w-[4px] cursor-col-resize;
}

//.tableWrapper tbody .resize-cursor {
//  @apply cursor-col-resize;
//}

.row-resize-handle {
  @apply bg-blue-500 absolute cursor-row-resize;
  @apply left-0 w-full h-[4px];
  //@apply top-[-2px] right-0 left-[-2px] w-[40px];
}
</style>
