 ...
 */
export function edgeCell(view, event, side, handleHeight) {
    var _a;
    ...
    //
    if (side === "bottom" && ((_a = $cell.nodeAfter) === null || _a === void 0 ? void 0 : _a.nodeSize))
        return $cell.pos; // fix: always add full cell size
