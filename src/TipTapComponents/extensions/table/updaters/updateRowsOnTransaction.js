export function updateRowsOnTransaction(view, parent, rowIndex, newHeight) {
    ...
    const tr = state.tr.setNodeMarkup(rowPos, null, Object.assign(Object.assign({}, rowNode.attrs), { rowheight: newHeight }));
    dispatch(tr);
}
//# sourceMappingURL=updateRowsOnTransaction.js.map